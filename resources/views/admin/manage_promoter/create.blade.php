...
@section('admin_content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="col-md-12">
                <form method="post" action="{{ route('managePromoter.store') }}">
                    @csrf
                    <div class="row">
                        <div class="form-group col-6">
                            <label for="promoter_id">Promoter ID</label>
                              <input type="text" name="promoter_id" class="form-control" placeholder=" Enter promoter ID">
                          ...
                          <div class="form-group col-6">
                              ...
                              <textarea name="address" id="" class="form-control" cols="3" rows="3" placeholder="Enter address"></textarea>
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="transaction_password" class="form-control" placeholder="Enter transaction password">
