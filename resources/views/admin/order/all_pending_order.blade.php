...
@endsection
@section('admin_title', 'All pending order')
@section('dashobard_title', 'All pending order')
            ...
            <table id="allCategory" class="table table-bordered table-striped">
                ...
                @foreach ($orders as $order)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('activePendingOrder',$order->id) }}" class="btn btn-warning btn-xs"> <i class="fa fa-arrow-up"></i> Pending</a>
                        </td>
                        <td>
                            <a href="#" class="btn btn-sm btn-info btn-xs"> <i class="fa fa-edit"></i> </a>
                            <a href="{{ route('viewPendingOrder',$order->user_id) }}" class="btn btn-sm btn-success btn-xs"> <i class="fa fa-eye"></i> </a>
