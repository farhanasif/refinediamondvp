...
@endsection
@section('admin_title', 'Edit Sub Category')
@section('dashobard_title', 'Edit Sub Category')
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Subcategory Information</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="col-md-8 offset-md-2">
                <form method="post" action="{{ route('updateSubCategory',$subcategory->id) }}" enctype="multipart/form-data">
                    @csrf
